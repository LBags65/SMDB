...
Run the following code to launch the Shiny App UI locally
````r
...
C) All entries for the selected metabolite showing a brief overview of analysis methods and soil parameters. Users can click on an entry (highlighted in blue) for a more detailed view of each entry. 

D) Expanded details about one metabolite entry where users can view the chemical structure and scroll down in this box to view all the data collected for that entry
